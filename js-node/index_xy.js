...
const S5_PORT = process.env.S5_PORT || '' // Socks5端口(TCP)
const HY2_PORT = process.env.HY2_PORT || '' // Hy2端口(UDP)
const REALITY_PORT = process.env.REALITY_PORT || '' // Reality端口(TCP)

const CHAT_ID = process.env.CHAT_ID || '' // telegram推送chat_id
const BOT_TOKEN = process.env.BOT_TOKEN || '' // telegram推送bot_token
const SHOW_LOG = !['false', 'disable', 'no'].includes((process.env.SHOW_LOG || 'false').toLowerCase()) // 是否显示日志输出
